...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/v1/stores.json').then(function (response) {
      return _this.stores = response.data;
    });
  }
});
...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/sky_shift/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAmCA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <table>\n      <tbody>\n        <tr>\n          <th>ID</th>\n          <th>name</th>\n        </tr>\n        <tr v-for=\"s in stores\" :key=\"s.id\">\n          <td>{{ s.id }}</td>\n          <td>{{ s.name }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</template>\n\n<script>\nimport axios from 'axios';\n\nexport default {\n  data: function () {\n    return {\n      stores: []\n    }\n  },\n  mounted () {\n    axios\n      .get('/api/v1/stores.json')\n      .then(response => (this.stores = response.data))\n  }\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=hello_vue-fc3b33efe227a12e5e92.js.map